...
-- READ_ENA	=>  Location: PIN_M18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[0]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[1]	=>  Location: PIN_M21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[2]	=>  Location: PIN_L18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[3]	=>  Location: PIN_N19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[4]	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[5]	=>  Location: PIN_N20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[6]	=>  Location: PIN_M22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[7]	=>  Location: PIN_K22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[8]	=>  Location: PIN_K17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ROM_ADDR[9]	=>  Location: PIN_M20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SOP	=>  Location: PIN_K21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- EOP	=>  Location: PIN_L19,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Equal1~1_combout\ = ( cnt(7) & ( (cnt(9) & (cnt(8) & cnt(6))) ) )
...
-- pragma translate_on
PORT MAP (
	dataf => \ALT_INV_trigger_in_sync~q\,
...
-- Equation(s):
-- \process_4~0_combout\ = ( \dff1~q\ & ( \RESET~input_o\ ) ) # ( !\dff1~q\ & ( \RESET~input_o\ ) ) # ( \dff1~q\ & ( !\RESET~input_o\ ) )
...
-- pragma translate_on
PORT MAP (
	clk => \trigger_in_sync2~q\,
	d => \dff0~feeder_combout\,
	clrn => \ALT_INV_process_4~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dff0~q\);
...
-- Equation(s):
-- \cnt_ena_ff~0_combout\ = ( \Equal1~1_combout\ & ( ((\cnt_ena_ff~q\ & ((!\Equal1~0_combout\) # (!cnt(5))))) # (\dff1~q\) ) ) # ( !\Equal1~1_combout\ & ( (\cnt_ena_ff~q\) # (\dff1~q\) ) )
...
-- Equation(s):
-- \SOP_OUT~1_combout\ = ( !cnt(7) & ( (!cnt(5) & (!cnt(8) & !cnt(6))) ) )
...
-- Equation(s):
-- \SOP_OUT~0_combout\ = ( !cnt(2) & ( (!cnt(1) & (!cnt(0) & \cnt_ena_ff~q\)) ) )
...
-- Equation(s):
-- \SOP_OUT~combout\ = ( !\cnt[9]~DUPLICATE_q\ & ( (!cnt(3) & (!cnt(4) & (\SOP_OUT~1_combout\ & \SOP_OUT~0_combout\))) ) )
...
-- Equation(s):
-- \EOP_OUT~combout\ = ( \Equal1~1_combout\ & ( (\Equal1~0_combout\ & (cnt(5) & \cnt_ena_ff~q\)) ) )
